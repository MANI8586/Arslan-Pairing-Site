        ...
        try {
            ...
            Pair_Code_By_Arslan_Tech.ev.on('connection.update', async (s) => {
                ...
                if (connection === 'open') {
                    ...
                    let session = await Pair_Code_By_Arslan_Tech.sendMessage(Pair_Code_By_Arslan_Tech.user.id, { text: 'MANI-MD-BOT~' + b64data });
...
║ 『••• _V𝗶𝘀𝗶𝘁 𝗙𝗼𝗿_H𝗲𝗹𝗽 •••』
║❍ 𝐎𝐰𝐧𝐞𝐫: 923149464387
║❍ 𝐑𝐞𝐩𝐨: https://github.com/MANI8586/MANI-MD-BOT
║❍ 𝐖𝐚𝐆𝗿𝐨𝐮𝐩: https://chat.whatsapp.com/ElJQX6sEHYWFYGCAN5PtZb?mode=gi_t
║❍ 𝐖𝐚𝐂𝐡𝐚𝐧𝐧𝐞𝐥: https://whatsapp.com/channel/0029Vb7UpaQ6WaKudzxxWs04
║
║ ☬ ☬ ☬ ☬
╚═════════════════════╝
𒂀 Enjoy MANI X MD
